...
moved {
    ...
    to = module.vpc.aws_security_group.default
}
...
moved {
  from = aws_cloudwatch_log_group.vpc_flow_logs
    to = module.vpc.aws_cloudwatch_log_group.vpc_flow_logs
}

moved {
  from = aws_iam_role.vpc_flow_logs_role
    to = module.vpc.aws_iam_role.vpc_flow_logs_role
  
}

moved {
  from = aws_iam_role_policy.vpc_flow_logs_policy
    to = module.vpc.aws_iam_role_policy.vpc_flow_logs_policy
}

moved {
    from = aws_flow_log.vpc_flow_logs
    to = module.vpc.aws_flow_log.vpc_flow_logs
       
}

moved {
    from = aws_s3_bucket.cloudtrail_logs
    to = module.vpc.aws_s3_bucket.cloudtrail_logs
}

moved {
    from = aws_cloudtrail.network_trail
    to = module.vpc.aws_cloudtrail.network_trail
}

moved {
    from = aws_iam_role.cloud_trail
    to = module.vpc.aws_iam_role.cloud_trail
  
}

moved {
    from = aws_cloudwatch_log_group.cloud_trail
    to = module.vpc.aws_cloudwatch_log_group.cloud_trail

}

moved {
    from = aws_iam_role_policy.cloud_trail_policy
    to = module.vpc.aws_iam_role_policy.cloud_trail_policy
}

moved {
    from = aws_s3_bucket_policy.cloudtrail_policy
    to = module.vpc.aws_s3_bucket_policy.cloudtrail_policy
}

moved {
    from = aws_cloudwatch_log_metric_filter.error_filter
    to = module.vpc.aws_cloudwatch_log_metric_filter.error_filter
}

moved {
    from = aws_cloudwatch_metric_alarm.error_alarm
    to = module.vpc.aws_cloudwatch_metric_alarm.error_alarm
}

moved {
    from = aws_sns_topic.error_notifications
    to = module.vpc.aws_sns_topic.error_notifications
}

moved {
    from = aws_sns_topic_subscription.email_subscription
    to = module.vpc.aws_sns_topic_subscription.email_subscription
}
